...
class _SpecifyDestinationState extends State<SpecifyDestination> {
  ...
  Future navigateToTransportDetail(context, weight, date, originPoint,
      destinationPoint, originAddress, destinationAddress) async {
    Navigator.pushNamed(context, TransportDetail.PATH, arguments: {
      "weight": weight,
      "date": date,
  ...
  Widget build(BuildContext context) {
    ...
    LatLng originPoint =
        LatLng(origin.target.latitude, origin.target.longitude);
